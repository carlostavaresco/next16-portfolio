...
export default function Footer() {
    return (
        <footer className="w-full flex justify-between items-end flex-wrap gap-y-12 px-6 md:px-12 pb-12 mt-40 pt-40 border-t border-subtle">
            {/* Contact Info */}
            <div className="w-full md:w-1/2 flex flex-col text-xs uppercase text-muted tracking-widest gap-2">
                <span>CONTATO</span>
                <span>-</span>
            ...
            {/* Social Links */}
            <div className="w-full md:w-1/2 flex flex-col text-xs uppercase text-right tracking-widest gap-3 items-end opacity-80">
            ...
            <div className="w-full flex justify-center items-end mt-16 md:mt-32 overflow-hidden pointer-events-none select-none">
