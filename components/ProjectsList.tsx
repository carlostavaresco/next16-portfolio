...
export default function ProjectsList() {
    return (
        <section className="w-full px-16 mt-40">
            {/* Header section of the list - using grid */}
            <div className="grid grid-cols-8 gap-6 text-xs text-muted mb-12 uppercase">
            ...
            <div className="w-full flex flex-col border-t border-subtle">
                {projects.map((project, idx) => (
                    ...
                    >
                        <div className="col-span-8 md:col-span-3 text-lg font-medium text-foreground tracking-wide group-hover:translate-x-2 transition-transform duration-300">
                            {project.name}
                        </div>

                        {/* The design splits the category and year to the right side seamlessly */}
                        <div className="col-span-8 md:col-span-5 flex justify-between items-center text-sm md:text-xs text-muted">
